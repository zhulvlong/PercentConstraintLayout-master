...
import com.github.layout.iface.ITextViewFeature;
import com.github.layout.utils.TextViewUtils;
 ...
 * @author ZhongDaFeng
 */
public class SubTextViewHelper extends SubViewBaseHelper<TextView> implements ITextViewFeature {
    ...
    public SubTextViewHelper(Context context, TextView view, AttributeSet attrs) {
    ...
    public SubTextViewHelper setTypeface(String typefacePath) {
     ...
     */
    @Deprecated
    public SubTextViewHelper setIconNormal(Drawable icon) {
    ...
    @Deprecated
    public SubTextViewHelper setIconPressed(Drawable icon) {
    ...
    @Deprecated
    public SubTextViewHelper setIconUnable(Drawable icon) {
    ...
    @Deprecated
    public SubTextViewHelper setIconSelected(Drawable icon) {
    ...
    @Deprecated
    public SubTextViewHelper setIconChecked(Drawable icon) {
    ...
    @Deprecated
    public SubTextViewHelper setIconSize(int iconWidth, int iconHeight) {
    ...
    @Deprecated
    public SubTextViewHelper setIconWidth(int iconWidth) {
        this.mIconWidth = iconWidth;
        setIcon();
        return this;
    }
    ...
    @Deprecated
    public SubTextViewHelper setIconHeight(int iconHeight) {
        this.mIconHeight = iconHeight;
        setIcon();
        return this;
    }
    ...
    @Deprecated
    public SubTextViewHelper setIconDirection(int iconDirection) {
     ...
     * *******新版本逻辑********
     */
    public SubTextViewHelper setIconNormalLeft(Drawable icon) {
    ...
    public SubTextViewHelper setIconNormalRight(Drawable icon) {
    ...
    public SubTextViewHelper setIconNormalTop(Drawable icon) {
    ...
    public SubTextViewHelper setIconNormalBottom(Drawable icon) {
    ...
    public SubTextViewHelper setIconPressedLeft(Drawable icon) {
    ...
    public SubTextViewHelper setIconPressedRight(Drawable icon) {
    ...
    public SubTextViewHelper setIconPressedTop(Drawable icon) {
    ...
    public SubTextViewHelper setIconPressedBottom(Drawable icon) {
    ...
    public SubTextViewHelper setIconUnableLeft(Drawable icon) {
    ...
    public SubTextViewHelper setIconUnableRight(Drawable icon) {
    ...
    public SubTextViewHelper setIconUnableTop(Drawable icon) {
    ...
    public SubTextViewHelper setIconUnableBottom(Drawable icon) {
    ...
    public SubTextViewHelper setIconSelectedLeft(Drawable icon) {
    ...
    public SubTextViewHelper setIconSelectedRight(Drawable icon) {
    ...
    public SubTextViewHelper setIconSelectedTop(Drawable icon) {
    ...
    public SubTextViewHelper setIconSelectedBottom(Drawable icon) {
    ...
    public SubTextViewHelper setIconCheckedLeft(Drawable icon) {
        this.mIconCheckedLeft = icon;
        setIconLeft(icon);
        return this;
    }

    public SubTextViewHelper setIconCheckedRight(Drawable icon) {
        this.mIconCheckedRight = icon;
        setIconRight(icon);
        return this;
    }

    public SubTextViewHelper setIconCheckedTop(Drawable icon) {
        this.mIconCheckedTop = icon;
        setIconTop(icon);
        return this;
    }

    public SubTextViewHelper setIconCheckedBottom(Drawable icon) {
    ...
    public SubTextViewHelper setIconSizeLeft(int iconWidth, int iconHeight) {
    ...
    public SubTextViewHelper setIconSizeRight(int iconWidth, int iconHeight) {
    ...
    public SubTextViewHelper setIconSizeTop(int iconWidth, int iconHeight) {
    ...
    public SubTextViewHelper setIconSizeBottom(int iconWidth, int iconHeight) {
    ...
    public SubTextViewHelper setTextColorNormal(@ColorInt int textColor) {
        this.mTextColorNormal = textColor;
        updateTextColor();
        return this;
    }

    public SubTextViewHelper setTextColorPressed(@ColorInt int textColor) {
    ...
    public SubTextViewHelper setTextColorUnable(@ColorInt int textColor) {
    ...
    public SubTextViewHelper setTextColorSelected(@ColorInt int textColor) {
    ...
    public SubTextViewHelper setTextColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int unable, @ColorInt int selected, @ColorInt int checked) {
    ...
    public SubTextViewHelper setTextColorChecked(@ColorInt int textColor) {
