...
import com.github.layout.clip.ClipHelper;
import com.github.layout.clip.ClipPathManager;
import com.github.layout.clip.IClip;
import com.github.layout.shadow.ShadowBitmapDrawable;
import com.github.layout.utils.RippleDrawableUtils;
 ...
 * @author ZhongDaFeng
 */
public class SubViewBaseHelper<T extends View> implements IClip, ViewTreeObserver.OnGlobalLayoutListener {
    //默认值 _C:颜色 _S:尺寸/宽高
    ...
    public SubViewBaseHelper(Context context, T view, AttributeSet attrs) {
        mView = view;
        mContext = context;
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        TypedArray a = mView.getContext().obtainStyledAttributes(attrs, R.styleable.SubBaseView_Layout);
        //corner
        mCornerRadius = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_corner_radius, -1);
        mCornerRadiusTopLeft = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_corner_radius_top_left, 0);
        mCornerRadiusTopRight = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_corner_radius_top_right, 0);
        mCornerRadiusBottomLeft = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_corner_radius_bottom_left, 0);
        mCornerRadiusBottomRight = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_corner_radius_bottom_right, 0);
        //border
        mBorderDashWidth = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_border_dash_width, _S);
        mBorderDashGap = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_border_dash_gap, _S);
        mBorderWidthNormal = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_border_width_normal, _S);
        mBorderWidthPressed = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_border_width_pressed, _S);
        mBorderWidthUnable = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_border_width_unable, _S);
        mBorderWidthChecked = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_border_width_checked, _S);
        mBorderWidthSelected = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_border_width_selected, _S);
        mBorderColorNormal = a.getColor(R.styleable.SubBaseView_Layout_sub_border_color_normal, _C);
        mBorderColorPressed = a.getColor(R.styleable.SubBaseView_Layout_sub_border_color_pressed, _C);
        mBorderColorUnable = a.getColor(R.styleable.SubBaseView_Layout_sub_border_color_unable, _C);
        mBorderColorChecked = a.getColor(R.styleable.SubBaseView_Layout_sub_border_color_checked, _C);
        mBorderColorSelected = a.getColor(R.styleable.SubBaseView_Layout_sub_border_color_selected, _C);
        //background
        //normal
        Object[] bgInfoNormal = getBackgroundInfo(a, R.styleable.SubBaseView_Layout_sub_background_normal);
        ...
        //pressed
        Object[] bgInfoPressed = getBackgroundInfo(a, R.styleable.SubBaseView_Layout_sub_background_pressed);
        ...
        //unable
        Object[] bgInfoUnable = getBackgroundInfo(a, R.styleable.SubBaseView_Layout_sub_background_unable);
        ...
        //checked
        Object[] bgInfoChecked = getBackgroundInfo(a, R.styleable.SubBaseView_Layout_sub_background_checked);
        ...
        //selected
        Object[] bgInfoSelected = getBackgroundInfo(a, R.styleable.SubBaseView_Layout_sub_background_selected);
        ...
        //gradient
        mGradientType = a.getInt(R.styleable.SubBaseView_Layout_sub_gradient_type, 0);
        mGradientOrientation = getGradientOrientation(a);
        mGradientRadius = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_gradient_radius, -1);
        mGradientCenterX = a.getFloat(R.styleable.SubBaseView_Layout_sub_gradient_centerX, 0.5f);
        mGradientCenterY = a.getFloat(R.styleable.SubBaseView_Layout_sub_gradient_centerY, 0.5f);
        //enabled
        mIsEnabled = a.getBoolean(R.styleable.SubBaseView_Layout_sub_enabled, true);
        //Ripple
        mUseRipple = a.getBoolean(R.styleable.SubBaseView_Layout_sub_ripple, false);
        mRippleColor = a.getColor(R.styleable.SubBaseView_Layout_sub_ripple_color, Color.RED);
        mRippleMaskDrawable = a.getDrawable(R.styleable.SubBaseView_Layout_sub_ripple_mask);
        mRippleMaskStyle = a.getInt(R.styleable.SubBaseView_Layout_sub_ripple_mask_style, MASK_STYLE_NORMAL);
        //shadow
        mShadowDx = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_shadow_dx, 0);
        mShadowDy = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_shadow_dy, 0);
        mShadowColor = a.getColor(R.styleable.SubBaseView_Layout_sub_shadow_color, Color.GRAY);
        mShadowRadius = a.getDimensionPixelSize(R.styleable.SubBaseView_Layout_sub_shadow_evaluation, -1);
        //clip
        mClipLayout = a.getBoolean(R.styleable.SubBaseView_Layout_sub_clip_layout, false);
    ...
    public SubViewBaseHelper setGradientRadius(float gradientRadius) {
    ...
    public SubViewBaseHelper setGradientCenterX(float gradientCenterX) {
    ...
    public SubViewBaseHelper setGradientCenterY(float gradientCenterY) {
     ...
     * @return
     */
    public SubViewBaseHelper setGradientType(int gradientType) {
    ...
    public SubViewBaseHelper setGradientOrientation(GradientDrawable.Orientation orientation) {
    ...
    public SubViewBaseHelper setStateBackgroundColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int unable, @ColorInt int checked, @ColorInt int selected) {
    ...
    public SubViewBaseHelper setStateBackgroundColorArray(int[] normalArray, int[] pressedArray, int[] unableArray, int[] checkedArray, int[] selectedArray) {
    ...
    public SubViewBaseHelper setStateBackgroundColor(Drawable normal, Drawable pressed, Drawable unable, Drawable checked, Drawable selected) {
    ...
    public SubViewBaseHelper setBackgroundColorNormal(@ColorInt int colorNormal) {
    ...
    public SubViewBaseHelper setBackgroundColorNormalArray(int[] colorNormalArray) {
    ...
    public SubViewBaseHelper setBackgroundDrawableNormal(Drawable drawableNormal) {
    ...
    public SubViewBaseHelper setBackgroundColorPressed(@ColorInt int colorPressed) {
    ...
    public SubViewBaseHelper setBackgroundColorPressedArray(int[] colorPressedArray) {
    ...
    public SubViewBaseHelper setBackgroundDrawablePressed(Drawable drawablePressed) {
    ...
    public SubViewBaseHelper setBackgroundColorUnable(@ColorInt int colorUnable) {
    ...
    public SubViewBaseHelper setBackgroundDrawableUnable(Drawable drawableUnable) {
    ...
    public SubViewBaseHelper setBackgroundColorUnableArray(int[] colorUnableArray) {
    ...
    public SubViewBaseHelper setBackgroundColorChecked(@ColorInt int colorChecked) {
    ...
    public SubViewBaseHelper setBackgroundColorSelected(@ColorInt int colorSelected) {
    ...
    public SubViewBaseHelper setBackgroundColorCheckedArray(int[] colorCheckedArray) {
    ...
    public SubViewBaseHelper setBackgroundColorSelectedArray(int[] colorSelectedArray) {
    ...
    public SubViewBaseHelper setBackgroundDrawableChecked(Drawable drawableChecked) {
    ...
    public SubViewBaseHelper setBackgroundDrawableSelected(Drawable drawableSelected) {
    ...
    public SubViewBaseHelper setShadowRadius(int shadowRadius) {
    ...
    public SubViewBaseHelper setShadowColor(int shadowColor) {
    ...
    public SubViewBaseHelper setShadowDx(int shadowDx) {
    ...
    public SubViewBaseHelper setShadowDy(int shadowDy) {
    ...
    public SubViewBaseHelper setUseRipple(boolean useRipple) {
    ...
    public SubViewBaseHelper setRippleColor(@ColorInt int rippleColor) {
    ...
    public SubViewBaseHelper setRippleMaskDrawable(Drawable rippleMaskDrawable) {
    ...
    public SubViewBaseHelper setBorderWidthNormal(int width) {
    ...
    public SubViewBaseHelper setBorderColorNormal(@ColorInt int color) {
    ...
    public SubViewBaseHelper setBorderWidthPressed(int width) {
    ...
    public SubViewBaseHelper setBorderColorPressed(@ColorInt int color) {
    ...
    public SubViewBaseHelper setBorderColorChecked(@ColorInt int color) {
    ...
    public SubViewBaseHelper setBorderColorSelected(@ColorInt int color) {
    ...
    public SubViewBaseHelper setBorderWidthChecked(int width) {
    ...
    public SubViewBaseHelper setBorderWidthSelected(int width) {
    ...
    public SubViewBaseHelper setBorderWidthUnable(int width) {
    ...
    public SubViewBaseHelper setBorderColorUnable(@ColorInt int color) {
    ...
    public SubViewBaseHelper setBorderWidth(int normal, int pressed, int unable, int checked,
                                            int selected) {
    ...
    public SubViewBaseHelper setBorderColor(@ColorInt int normal, @ColorInt int pressed,
    ...
    public SubViewBaseHelper setBorderDashWidth(float dashWidth) {
    ...
    public SubViewBaseHelper setBorderDashGap(float dashGap) {
    ...
    public SubViewBaseHelper setBorderDash(float dashWidth, float dashGap) {
        this.mBorderDashWidth = dashWidth;
        this.mBorderDashGap = dashGap;
        updateBorderValue();
        return this;
    ...
    public SubViewBaseHelper setCornerRadiusTopLeft(float topLeft) {
    ...
    public SubViewBaseHelper setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public SubViewBaseHelper setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public SubViewBaseHelper setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
    ...
    public SubViewBaseHelper setCornerRadius(float topLeft, float topRight, float bottomRight,
                                             float bottomLeft) {
        this.mCornerRadius = -1;
        this.mCornerRadiusTopLeft = topLeft;
        this.mCornerRadiusTopRight = topRight;
    ...
    private void addOnGlobalLayoutListener() {
        ...
        mView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            ...
            public void onViewAttachedToWindow(View v) {
                ...
                observer.addOnGlobalLayoutListener(SubViewBaseHelper.this);
            }

            @Override
            public void onViewDetachedFromWindow(View v) {
                ViewTreeObserver observer = v.getViewTreeObserver();
                observer.removeGlobalOnLayoutListener(SubViewBaseHelper.this);
    ...
    private GradientDrawable.Orientation getGradientOrientation(TypedArray a) {
        ...
        int gradientOrientation = a.getInt(R.styleable.SubBaseView_Layout_sub_gradient_orientation, 0);
